...
nPayAmt			number(6,2),	--not null,	--实付款金额---------------------
...
sRemark			varchar2(100),	--not null,	--备注信息---------------------
...
nDisAmt			number(6,2),	--not null,	--折扣金额----------------
...
sRetSendReMark	varchar2(64),	--not null,	--退品或赠送原因----------------
...
cPay_n		varchar2(64),	--not null,	--付款方式名称----------------
sUnit		varchar2(16),	--not null,	--付款单位----------------
nPayAmt		number(6,2),	--not null,	--付款本币金额----------------
cVIP_c		varchar2(32),				--会员卡号----------------
