...
(
   RESTAURANT_ID        VARCHAR2(32) ,   --餐厅编号
   BUSINESS_DATE        DATE ,           --餐厅营业时间
...
(
   ...
   FORM_ID              VARCHAR2(32),  --单据编号
   REASON               VARCHAR2(64),  --业务类型(配送、退货、报损等)
...
(
   ...
   ITEM_SPECIFICATION   VARCHAR2(32),   --规格
...
(
   ...
   REQUESTER            VARCHAR2(64),   --订货部门
   RECEIVER_ID          VARCHAR2(32),   --收货部门ID(只针对直配小单有效,其他为空)
   RECEIVER             VARCHAR2(64),   --收货部门(只针对直配小单有效,其他为空)
...
(
   ...
   FORM_TYPE            VARCHAR2(16),   --入库单类型(PURCHASING:采购入库,PRODUCE:生产入库,MANUAL:手动入库)
   INPUT_DEPARTMENT_ID  VARCHAR2(32),   --入库部门ID
   INPUT_DEPARTMENT     VARCHAR2(64),   --入库部门
   INPUTER_ID           VARCHAR2(32),   --入库人员ID
   INPUTER              VARCHAR2(64),   --入库人员
   STORAGE_ID           VARCHAR2(32),   --入库仓库标识(仅对多仓库有效)
   STORAGE              VARCHAR2(64),   --入库仓库名称(仅对多仓库有效)
   INPUT_TIME           DATE,           --入库时间
   PROVIDER_ID          VARCHAR2(32),   --供应商ID
   PROVIDER             VARCHAR2(96),   --供应商
   FORM_NOTE            VARCHAR2(200),  --备注说明
   AUDITOR_ID           VARCHAR2(32),   --审核人员ID
...
(
   ...
   ANTIAUDIT_BRANCH     VARCHAR2(64),   --反审核部门
...
(
   ...
   IN_BRANCH            VARCHAR2(64),   --调入部门
   IN_STORAGE_ID        VARCHAR2(32),   --入库仓库标识(仅对多仓库有效)
   IN_STORAGE           VARCHAR2(64),   --入库仓库名称(仅对多仓库有效)
   OUT_BRANCH_ID        VARCHAR2(32),   --调出部门ID
   OUT_BRANCH           VARCHAR2(64),   --调出部门
   OUT_STORAGE_ID       VARCHAR2(32),   --出库仓库标识(仅对多仓库有效)
   OUT_STORAGE          VARCHAR2(64),   --出库仓库名称(仅对多仓库有效)
...
(
   ...
   ITEM_ID              VARCHAR2(32),  --商品编码
   ITEM_NAME            VARCHAR2(64),  --商品名称
   ITEM_DIMENSION       VARCHAR2(32),  --库存单位
   ITEM_DIMENSION2      VARCHAR2(32),  --包装单位
   ITEM_SPECIFICATION   VARCHAR2(32),  --规格
...
(
   ...
   ITEM_ID              VARCHAR2(32),  --商品编码
   ITEM_NAME            VARCHAR2(64),  --商品名称
   ITEM_DIMENSION  		VARCHAR2(32),  --包装单位
