...
(
   ...
   CATEGORY_NAME        VARCHAR2(80),  --类别名称
   PARENT_ID            VARCHAR2(32),  --父类别ID
   CATEGORY_LEVEL       VARCHAR2(8),   --类别级别
   ITEM_TYPE            VARCHAR2(8),   --类型(原材料:RAW/半成品:SEMIS/成品:PRODUCT)
...
(
   ...
   ITEM_NAME_ENG        VARCHAR2(64),  --原料简称或出品英文名称
   ITEM_DIMENSION       VARCHAR2(16),  --原料库存单位或出品例牌
   ...
   BOX_TYPE				VARCHAR2(32),  --箱子类型(冷藏/非冷藏)
   ENABLED				INTEGER,	   --是否启用(0未启用，1已启用)
...
(
   ...
   ITEM_NAME            VARCHAR2(64),  --原材料名称
   ITEM_DIMENSION       VARCHAR2(16),  --原材料配方单位
...
(
   BRANCH_ID            VARCHAR2(32),  --部门标识
   ITEM_ID              VARCHAR2(32),  --商品编码
   ALLOCATION           NUMBER(12,4),  --已分配量
   ON_THE_WAY           NUMBER(12,4),   --在途量
