...
<script language="javascript" type="text/javascript"
	src="<%=appRoot%>/mobile/module/businessquery/shopListQuery/main.js?Version=<%=currenttime %>"></script>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-user"></i>门店收入明细信息
				</h2>
			</div>
