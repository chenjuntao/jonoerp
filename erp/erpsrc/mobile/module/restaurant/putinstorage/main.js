...
function getQueryUrl() {
	...
	var _url = appRoot + "/m/restaurant/putinstorage/outside/doQuery.action?formType=request";
	return _url + params;
}
function initTable() {
...
function gotoURL(_formId) {
	var _url = appRoot + "/restaurant/putinstorage/outside/scanView.action?formId=" + _formId;
	window.open(_url);
}