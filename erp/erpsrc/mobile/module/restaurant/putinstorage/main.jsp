...
<script type="text/javascript" src="<%=appRoot%>/mobile/module/restaurant/putinstorage/main.js?Version=<%=currenttime %>"></script>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-user"></i>入库单查询
				</h2>
			</div>
