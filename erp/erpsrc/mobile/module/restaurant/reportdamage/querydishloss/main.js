...
function getQueryUrl() {
	...
	var _url = appRoot + "/m/restaurant/reportdamage/querydishloss/doQuery.action?formType=request";
	return _url + params;
}
function initTable() {
...
function doAudit(_formId) {
	...
	var _url = appRoot + "/restaurant/reportdamage/confirmdishloss/auditById.action?formId=" + _formId;
	$.ajax({
		type : "POST",
		url : _url,
		error : function(e) {
...
function gotoURL(_formId) {
	var _url = appRoot + "/restaurant/reportdamage/querydishloss/showView.action?formId=" + _formId;
	window.open(_url);
}