/*@lineinfo:filename=CfCostBean*//*@lineinfo:user-code*//*@lineinfo:1^1*/package logic.reportmanage;
...

{
  ...
  synchronized (__sJT_execCtx) {
    sqlj.runtime.profile.RTStatement __sJT_stmt = __sJT_execCtx.registerStatement(__sJT_connCtx, CfCostBean_SJProfileKeys.getKey(0), 0);
    try 
    {
...
}/*@lineinfo:generated-code*/class CfCostBean_SJProfileKeys 
{
  private static CfCostBean_SJProfileKeys inst = null;
  public static java.lang.Object getKey(int keyNum) 
    throws java.sql.SQLException 
  {
    if (inst == null)
    {
      inst = new CfCostBean_SJProfileKeys();
    }
    return inst.keys[keyNum];
  }
  private final sqlj.runtime.profile.Loader loader = sqlj.runtime.RuntimeContext.getRuntime().getLoaderForClass(getClass());
  private java.lang.Object[] keys;
  private CfCostBean_SJProfileKeys() 
    throws java.sql.SQLException 
  {
    keys = new java.lang.Object[1];
    keys[0] = DefaultContext.getProfileKey(loader, "logic.reportmanage.CfCostBean_SJProfile0");
  }
}
