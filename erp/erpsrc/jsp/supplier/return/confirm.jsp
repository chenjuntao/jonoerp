...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/return/confirm.js"></script>
	...
	<table class="hovertable" width="100%" border="1">
		<tr>
			<td style="text-align: center;">
			    <input type="button" onclick="doConfirm();" id="btn_submit" value="采购退货确认" style="margin-left: 8px;" />
			</td>
		</tr>
	</table>
