...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/statement/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/supplier/statement/main.css">
		...
		<tr>
			...
			<td class="text_left" >
				<s:select list="shopLst" listKey="code" listValue="name" theme="simple"  headerKey="" headerValue="------请选择供应商------"
					 style="width: 180px;"  name="supplierId"> </s:select>
			</td>
			
			<td class="label_right" style="width: 60px;">部门编码：</td>
			<td class="text_left" >
				<s:select list="branchLst" listKey="code" listValue="name" theme="simple" headerKey="" headerValue="------请选择门店------"
					 style="width: 180px;"  name="branchId"> </s:select>
			</td>
			
			<td class="label_right" style="width: 80px;">操作日期：</td>
				<td class="text_left">
