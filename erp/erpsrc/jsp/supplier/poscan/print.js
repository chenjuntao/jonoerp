	...
	require(
			...
			function(array) {
				...
				for ( var index in printColumns) {
					...
					if (printColumns[index].field == 'none') {
						continue;
					}
				...
				var l_deliveryType = dojo.byId('deliveryType').innerHTML;
				...
				var strBodyStyle = "<style> table {font-family: verdana,arial,"
						...
						+ ".print-payAmt,.print-itemSpecification {width: 135px;} .print-itemId,.print-receiver{width: 165px;}.print-itemUnitPrice,.print-expiredTime{width: 75px;} "
