...
<head>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/supplier/price/main.css"/>
	
	<script type="text/javascript" src='<%=dojoBase %>/dojo/dojo.js'></script>
	<script type="text/javascript" src="<%=dojoBase %>/My97DatePicker/WdatePicker.js"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/price/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/price/export.js?Version=<%=currenttime %>"></script>
...
<body bgcolor="white" class="claro">
	...
	<form id="queryForm">
		<table class="hovertable" width="100%" border="1">
			<tr valign="middle">
				<td>
					<div id="placeHoldCer"></div>
					原料编码<input type="text" id="itemId" name="itemId"  style="margin-left: 8px;" />
					供应商编码<input type="text" id="supplierId" name="supplierId"  style="margin-left: 8px;" />
					<button style="margin-left: 50px" data-dojo-type="dijit/form/Button"   data-dojo-props='onClick: doQuery'>查询</button>
