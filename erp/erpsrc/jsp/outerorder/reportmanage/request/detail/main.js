...
function getAppendValue() {
	...
	var appendValue = " AND H.FORM_TYPE = 'outer' ";
	...
	if (!isEmpty(branchCondition)) {
		...
		appendValue += " AND h.BUYER_ID = '" + loginBranchId + "' "
	}
...
function init() {
	require([ "dojo/dom", "dojo/request/xhr", "dojo/_base/array", "dojo/dom-form", "dojo/parser", "dijit/form/Select",
			"dojo/data/ObjectStore", "dojo/store/Memory", "dijit/form/ComboBox", "dijit/form/FilteringSelect",
			"dijit/form/Button", "dijit/Dialog", "dojo/domReady!" ], function(dom, xhr, array, domForm, parser, Select,
			ObjectStore, Memory, ComboBox, FilteringSelect) {
