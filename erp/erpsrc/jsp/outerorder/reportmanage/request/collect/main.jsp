...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/reportmanage/request/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/reportmanage/request/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/reportmanage/request/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/reportmanage/request/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/reportmanage/request/collect/print.css">
...
<!-- 		参数区域 -->
		...
		<input id="append"  name="append" type="hidden" value=" AND H.FORM_TYPE = 'outer' "/>
		<input id="branchType"   name="branchType" type="hidden" value="OUTERORDER"/>
		<input  name="collectFlag" type="hidden" value="head"/>
		<input name="reportFlag" type="hidden" value="D_T1_REQUEST_HEADER"/>
		</div>
	</form>
</body>
