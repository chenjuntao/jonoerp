...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/outscan/scan.js?Version=<%=currenttime %>"></script>
    ...
    <!-- 引用新增要货单页面create的样式 -->
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/outscan/scan.css">
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<input type='hidden' name='shippingHeader.formId'
			 value='${shippingHeader.formId }' />
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="3">
	  				 <input type="button" id="btn_submit" value="出货单确认" style="padding-left: 8px;" />
				</td>
			</tr>
		</table>
