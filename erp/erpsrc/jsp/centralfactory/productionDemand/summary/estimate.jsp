...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/summary/estimate.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" colspan="4">
	  				<input type="text" name="formNote"  style="width: 280px;" />
	  				
	  				 <input type="button" onclick="doSubmit();" id="submitBtn" value="提交生产计划单" style="margin-left:20px;" />
				</td>
			</tr>
		</table>
