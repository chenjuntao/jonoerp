...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/summary/scan.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<div id="dataGrid" class="scanGrid"></div>
	</form>
