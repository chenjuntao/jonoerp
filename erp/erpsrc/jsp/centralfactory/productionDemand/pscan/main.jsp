...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/pscan/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/productionDemand/pscan/main.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="OTHER_P_SCAN"/>
		</div>
	</form>
</body>
