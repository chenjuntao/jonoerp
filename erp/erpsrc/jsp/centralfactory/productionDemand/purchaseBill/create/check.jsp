...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/purchaseBill/create/check.js?Version=<%=currenttime %>"></script>
...
<!-- 		<input type='hidden' name='requestHeader.formType' value='estimate' /> -->
		...
		<input type='hidden' name='requestHeader.buyerId' value='${cfCode }' />
...
<!-- 			</tr> -->
			<tr>
				...
				<td class="text_left" colspan="5">
			    	...
			    	<input type="button" id="btn_submit" value="确定提交原料采购单" style="margin-left: 58px;" />
				</td>
			</tr>
		</table>
		...
		<div id="dataGrid" class="checkGrid" style="top: 95px;">
		</div>
	</form>	
</body>
