...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/purchaseBill/arrangementCreate/check.js?Version=<%=currenttime %>"></script>
...
<body class="claro">
	<form id="billForm" method="post" >
		...
		<input type='hidden' name='commonHeader.storageId' value='${commonHeader.storageId }' />
		<input type='hidden' name='commonHeader.storage' value='${commonHeader.storage }' />
...
<%-- 		<input type='hidden' name='commonHeader.receiveTime' value='${receiveTime }' /> --%>
		<input type='hidden' name='commonHeader.formNote' value='${commonHeader.formNote }' />
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" colspan="2">
					<span>${commonHeader.storage }</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="text_left" colspan="5">
					<span style="display: inline-block;width: 300px;">${commonHeader.formNote }</span>
