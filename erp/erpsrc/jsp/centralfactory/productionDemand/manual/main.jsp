...
<%-- 	<script type="text/javascript" src='<%=dojoBase %>/dojo/dojo.js' data-dojo-config="async:1"></script> --%>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/productionDemand/manual/main.js?Version=<%=currenttime %>"></script>
		...
		<td class="label_right" style="width: 162px;">制单人员：</td>
			...
			<td class="label_right">备注：</td>
				...
				<td class="text_left" colspan="2">
				    ...
				    <input type="button" onclick="doSubmit();" value="提交生产计划单" style="margin-left:20px;" />
				</td>
			</tr>
		</table>
