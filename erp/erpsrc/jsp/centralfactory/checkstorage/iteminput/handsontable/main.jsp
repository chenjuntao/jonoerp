...
<%-- 	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script> --%>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/checkstorage/iteminput/handsontable/main.js?Version=<%=currenttime %>"></script>
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<s:select list="batchLst" theme="simple" onchange="loadCheckList(checkBatchId,checkId);" 
						 style="width: 170px;" id="checkBatchId" name="checkHeader.checkBatchId"></s:select>
				</td>
				...
				<td class="text_left">
				<s:select list="formLst" theme="simple" listKey="formId" listValue="formId" onchange="loadGridData();" 
						 style="width: 170px;" id="checkId" name="checkHeader.formId"></s:select>
			</tr>
		</table>
