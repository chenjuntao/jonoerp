...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/cost/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/cost/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/reportmanage/cost/main.css">
	...
	<form id="dataForm" method="post" >
	   <table class="hovertable" width="100%" border="1" style="height: 35px;">
				...
				<td>
					...
					<input type="button"  onclick="toHelpPage('CF_COST');" value="帮助文档" style="margin-left: 20px;" />
				</td>
