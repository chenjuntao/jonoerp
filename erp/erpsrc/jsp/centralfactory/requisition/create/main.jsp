...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/create/requisitionGrid.js"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/create/main.js?Version=<%=currenttime %>"></script>
	...
	<table class="hovertable" width="100%" border="1">
		<tr>
			...
			<td class="text_left" style="width: 285px;">
				<input type="text" class="Wdate" id="startDate" value="${businessDate}" style="width: 120px;"	onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\',{d:0});}'})" /> 
				<span style="padding: 0 5px;">至</span> 
				<input	type="text" class="Wdate" id="endDate" value="${businessDate}"	style="width: 120px;" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'startDate\',{d:0});}'})" />	
			</td>
