...
<head>
	...
	<script type="text/javascript" 
		src="<%=appRoot %>/jsp/centralfactory/requisition/manual/audit/audit.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left">
			    	...
			    	<input type="button" onclick="doAudit();" id ="auditBtn" value="审核通过"  style="margin-left: 58px;" />
