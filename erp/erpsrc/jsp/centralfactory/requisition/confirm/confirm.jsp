...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/confirm/confirm.js?Version=<%=currenttime %>"></script>
	...
	<form id="billForm" method="post" >
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="label_right" style="width: 90px;">对应工单编号：</td>
			...
			<tr>
				...
				<td class="text_left">
			    	...
			    	<input type="button" onclick="doConfirm();" value="确认领料"	 style="margin-left: 58px;" />
