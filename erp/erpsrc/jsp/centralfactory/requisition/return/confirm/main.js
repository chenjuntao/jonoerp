...
var grid = null;
function initGrid() {
	var _url = appRoot + "/cf/requisition/manage/doQuery.action?queryType=unconfirm&formType=return";
	_url = getUrl(_url);
...
function doConfirm(row) {
	...
	var _url = appRoot + "/cf/requisition/return/confirm/confirmView.action?formId=" + row.formId + "&parentTabId="
			+ tabId;
	_url = getUrl(_url);
