...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/inventory/in/create/create.js?Version=<%=currenttime %>"></script>
...
<%-- 						style="width: 180px;" id="storageId" name="inputHeader.storageId"></s:select> --%>
					<input type="hidden" id="storageId" name="inputHeader.storageId" value="F00A" />
					<input type="hidden" id="storage" name="inputHeader.storage" value="[F00A]长沙中央仓库" />
				</td>
			</tr>
