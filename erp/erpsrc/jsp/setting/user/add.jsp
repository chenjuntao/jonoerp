...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/setting/user/add.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 120px;">
		 			<input type="text" id="userId" name="user.userId" value="${user.userId}" style="width: 80px;" />
				</td>
			...
			<tr>
				...
				<td class="text_left" colspan="2">
					...
					<span id="roleText" style="display: inline-block;"></span>
					<input type="button" onclick="setRole()" value="选择角色" />
				</td>
			</tr>
		</table>
	</form>
