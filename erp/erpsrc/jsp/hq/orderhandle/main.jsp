...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/orderhandle/order.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/orderhandle/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/orderhandle/main.css">
		...
		<tr>
			...
			<td class="text_left" >
				<s:select list="shopLst" listKey="code" listValue="name" theme="simple"
					 style="width: 180px;" id="outOrderId" name="outOrderId" headerKey="" headerValue="-----请选择外部订货方-----"> </s:select>
			</td>
			...
			<select id="status">
			  ...
			  <option value ="外部订货方已对账" >总部对账确认</option>
			  <option value ="已付款" >收款确认</option>
			</select>
			</td>
