...
<script type="text/javascript"
	src="<%=appRoot%>/jsp/common/js/gridx-util.js"></script>
<script type="text/javascript"
	src="<%=dojoBase%>/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript"
	src="<%=appRoot%>/jsp/hq/pricechange/main.js?Version=<%=currenttime %>"></script>
<script type="text/javascript"
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td class="label_right" style="width: 100px;">生效日期：</td>
				<td class="text_left" style="width: 260px;">
					<input type="text" class="Wdate" id="startDate" name="startDate" value="${businessDate}"
						style="width: 110px;" onFocus="WdatePicker()" />
					<span style="padding: 0 5px;">至</span>
					<input type="text" class="Wdate" id="endDate" name="endDate" value="${businessDate}"
						style="width: 110px;" onFocus="WdatePicker()" />
			   	 
				</td>
				
				<td style="width: 350px;">
					<input type="button" id="DIYwithnoModel" onclick="selMaterial();" value="选择原料" style="margin-left:10px;" />
					<input type="hidden" id=itemId  name="itemId" value=""/>
					<input type="hidden" id=itemName  name="itemName" value=""/>
					<span id="displayItemName"></span>
				</td>
				
				<td>	<input type="button" onclick="doQuery();" value="查询" /></td>
			</tr>
		</table>
		
		 <div id="chartNode" style="width:100%;height:430px;"></div>
        <div id="legend"></div>
	</form>
