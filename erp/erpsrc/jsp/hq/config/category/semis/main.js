...
function doAdd() {
	...
	var _title = "新增类别";
	var _url = appRoot + "/hq/category/raw/addView.action?itemType=SEMIS&parentId=" + _parentId;
	_url = getUrl(_url);
 ...
 */
function deletable() {
	var _url = appRoot + "/hq/category/raw/deletable.action?categoryId=" + dojo.byId('categoryId').value;
	_url = getUrl(_url);
