...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/item/process/processEdit.js?Version=<%=currenttime %>"></script>
			...
			<tr>
				<td colspan="4">
					<b style="padding-left: 8px;">工序信息</b>
			   	 	...
			   	 	<input type="button" onclick="doAdd();" value="新增" style="margin-left: 58px;" />
