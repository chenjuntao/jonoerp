...
<head>
	<title>semi product config</title>
	<%@ include file="/jsp/common/jsp/path.jsp"%>
	
    <script type="text/javascript" src="<%=dojoBase %>/dojo/dojo.js" ></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/dgrid-util.js?Version=<%=currenttime %>"></script>
    <script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/item/semi/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/item/semi/export.js?Version=<%=currenttime %>"></script>
<%-- 			<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/item/product/export.js?Version=<%=currenttime %>"></script> --%>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/config/item/semi/main.css">
...
<!-- 导出 打印对话框 -->
	...
	<div id="customDialog1"  style="display: none;" data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出成本卡"'>
		...
		<!-- 导出 打印对话框 -->
	<div id="customDialog2"  style="display: none;" data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出半成品"'>
		<table style="position:relative;">
			<tr>
				<td>
					<label for="type">导出格式: </label>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					...
					<input type="radio" name="searchType" value="product"  checked="checked" /> 按产品
					...
					<button  data-dojo-type="dijit/form/Button"   style="margin-left: 50px;"  data-dojo-props='onClick: doQuery'>查  询</button>
										<button  data-dojo-type="dijit/form/Button" style="margin-left: 10px;" data-dojo-props='onClick: showDialog2'>批量导出半成品</button>
...
<!-- 					<button  data-dojo-type="dijit/form/Button" style="margin-left: 10px;" data-dojo-props='onClick: showDialog'>批量导出成本卡</button> -->
					<button  data-dojo-type="dijit/form/Button"   style="margin-left: 10px;" data-dojo-props='onClick: doAdd'>新增</button>
			   	 	<button  data-dojo-type="dijit/form/Button"   style="margin-left: 50px;" data-dojo-props='onClick: doDelete'>删  除</button>
			   	 	<button  data-dojo-type="dijit/form/Button" style="margin-left: 10px;" data-dojo-props='onClick: doCompute'>半成品成本价即时计算</button>
				</td>
			</tr>
		</table>
	</form>
