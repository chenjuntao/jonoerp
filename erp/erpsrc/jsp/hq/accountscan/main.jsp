...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/accountscan/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/accountscan/main.css">
