...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/priceadjust/purchase/main.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 180px;">
	 			...
	 			<td>
	 				<input type="button" onclick="doQuery();" value="查    询" style="width: 60px;margin-left: 20px"  />
 				</td>
