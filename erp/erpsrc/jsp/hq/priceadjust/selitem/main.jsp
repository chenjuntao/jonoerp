...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/priceadjust/selitem/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/priceadjust/selitem/main.css"/>
