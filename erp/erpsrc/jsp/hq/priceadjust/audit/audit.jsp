...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/priceadjust/audit/audit.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="3">
				    ...
				    <input type="button" onclick="doAudit();" id="bnt_submit" value="审核" style="margin-left: 8px;" />
				</td>
			</tr>
		</table>
