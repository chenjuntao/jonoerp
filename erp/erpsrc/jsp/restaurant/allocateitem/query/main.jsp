	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" >
					<s:select list="shopLst" listKey="code" listValue="name" theme="simple"  style="width: 150px;" id="inBranchId" name="transferHeader.inBranchId" onchange= "refreshStorage1(inBranchId,inStorageId)"></s:select>
					<input type="hidden" id="inBranch" name="transferHeader.inBranch"  />
				</td>
				
				<td class="label_right" style="width: 100px;">调入仓库：</td>
				
				<td>
					<s:select list="inStorageList" listKey="storageId" listValue="storageName" theme="simple" style="width: 180px;" id="inStorageId" name="transferHeader.inStorageId" headerKey="" headerValue="--请选择--"></s:select>
