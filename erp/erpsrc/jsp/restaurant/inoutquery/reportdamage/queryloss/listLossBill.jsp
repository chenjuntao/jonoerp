...
<head>
	...
	<script type="text/javascript" src="<%=appRoot%>/jsp/restaurant/inoutquery/reportdamage/queryloss/listLossBill.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot%>/jsp/restaurant/inoutquery/reportdamage/queryloss/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot%>/jsp/restaurant/inoutquery/reportdamage/queryloss/main.css">
</head>
