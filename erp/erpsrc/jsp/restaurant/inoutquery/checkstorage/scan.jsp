...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/checkstorage/scan.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/form.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/checkstorage/exportDetail.js"></script>
    ...
    <link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/inoutquery/checkstorage/scan.css">
	...
	<form id="billForm" method="post" >
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left">
					<span>${checkHeader.formMaker}</span>
				</td>
