...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/shipping/main.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 160px;">
					<s:select list="shopLst" listKey="code" listValue="name" theme="simple" headerKey="-1" headerValue="--请选择--" style="width: 150px;" id="branchId"></s:select>
				</td>
