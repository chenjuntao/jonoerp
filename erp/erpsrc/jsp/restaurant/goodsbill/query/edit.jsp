...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/goodsbill/query/edit.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" style="height: 100%" >
...
<%-- 					<input type="text" class="Wdate" name="requestHeader.receiveTime" value="${receiveTime}" /> --%>
			...
			<tr>
				...
				<td colspan="4">
					<input type="button" onclick="calcSuggest();" value="重新计算建议值" style="margin-left: 10px;">
