...
function queryData() {
	var _url = appRoot+ "/restaurant/checkstorage/imanage/queryCheckHeader.action?batchId="+ dojo.byId('checkBatchId').value;
...
function doScan(row) {
	...
	var _url = appRoot+ "/restaurant/checkstorage/imanage/scanView.action?formId="+ row.formId;
	_url = getUrl(_url);
...
function doEdit(row) {
	...
	var _url = appRoot	+ "/restaurant/checkstorage/imanage/editView.action?formId="+ row.formId + "&parentTabId=" + tabId;
