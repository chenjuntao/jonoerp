...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/form/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/form/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/form/main.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_SHIPPING_FORM"/>
		</div>
	</form>
</body>
