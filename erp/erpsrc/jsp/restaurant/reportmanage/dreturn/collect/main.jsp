...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/input/collect/print.css">
   ...
   <table class="hovertable" width="100%" border="1" style="height: 35px;">
	   <tr>
			...
			<td  style="width: 220px;">
				<label for="branchCondition2">订货门店：</label>
		...
		<input name="reportFlag" type="hidden" value="D_T1_RETURN_GOODS_DELIVERY_HEADER"/>
