...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/preject/confirm/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/preject/manage/main.css">
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td class="label_right" style="width: 100px;">退货日期：</td>
