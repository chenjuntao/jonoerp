...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/antiaudit/audit/main.js?Version=<%=currenttime %>"></script>
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="label_right" style="width: 70px;">${branchCondition}:</td>
				<td class="text_left">
