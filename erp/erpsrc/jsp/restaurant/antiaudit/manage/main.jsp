...
<head>
	<title>shipping anti audit manage</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/antiaudit/manage/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/antiaudit/manage/main.css">
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="label_right" style="width: 80px;">${branchCondition}：</td>
				<td class="text_left">
