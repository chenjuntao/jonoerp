...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/dailysettlement/settle.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="settleForm" method="post" >
		...
		<tr>
			<td class="label_right">日结进度：</td>
					<td class="text_left" >
					 <div data-dojo-type="dijit/ProgressBar" style="width:300px;height:15px"
