...
function initGrid() {
	var _url = appRoot + "/restaurant/common/mrp/cf/doCfMrpQuery.action?branchId="
...
function scanDetail(row) {
	var _url = appRoot + "/common/mrp/mainView.action?itemId="+ row.itemId + "&branchType=CENTRALFACTORY" + "&mrpType=allocation" + "&parentTabId=" + tabId;
	
	addTab("中央工厂已分配量", _url);
}

function scanDetail2(row) {
	var _url = appRoot + "/common/mrp/mainView.action?itemId="+ row.itemId + "&branchType=CENTRALFACTORY" + "&mrpType=onTheWay" + "&parentTabId=" + tabId;
