...
配送单据编号</label>
  ...
  <p>配送退货审核人
    <label>
    <input name="confirmRejectPeople" type="text" id="confirmRejectPeople">
    </label>
    （自动生成）配送退货审核日期输入
    <label>
  <input name="confirmRejectDate" type="text" id="confirmRejectDate">
    </label>
  </p>
  <table class="hovertable" width="100%" border="1" cellpadding="6" cellspacing="2"
			bordercolor="#FEB5AE" bgcolor="#E9EFF5" align="center">
    <tr valign="middle">
      <td width="800"><div align="Left"><b>配送退货明细</b></div></td>
    </tr>
  </table>
  ...
  <p>
      <label></label>
      <label>
      <input name="confirmBill" type="submit" id="confirmBill" value="配送退货单审核通过">
      </label>
  （配送退货单状态变为未处理）</p>
</form>
</body>
