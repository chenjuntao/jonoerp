...
<script type="text/javascript"
	src="<%=appRoot%>/jsp/restaurant/prototype/allocateitem/agreeallocateitembill/listAllocateItemBill.js?Version=<%=currenttime %>"></script>
...
<label>（注：显示该门店所有未确认的调拨单，调出部门是该门店）</label>
	    

<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					<div style="padding-left: 8px;"><strong>未确认餐厅调拨单列表</strong></div>
				</td>
			</tr>
  </table>
  ...
  <div id="dataGrid">
    <label>     <a
					href='javascript: parent.addTab("餐厅调拨单确认+编号", "<%=appRoot %>/jsp/restaurant/prototype/allocateitem/agreeallocateitembill/agreeAllocateItemBill.jsp");'
					>确认餐厅调拨单</a> </label>
  </div>
    </form>
</body>
