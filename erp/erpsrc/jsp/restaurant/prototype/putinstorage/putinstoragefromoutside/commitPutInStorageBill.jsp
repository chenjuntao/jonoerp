...
<body bgcolor="white">
  ...
  <p align="left"> 入库单单据编号
    ...
    （注：自动生成，拼音缩写+部门编号+日期+流水号，进入此页面时自动生成，无法修改） </p>
  <p align="left">入库部门  
    <label>
...
备注
  ...
  <table class="hovertable" width="100%" border="1" cellpadding="6" cellspacing="2"
    ...
    <p>
      <label></label>
      <label>
      <input name="commitBill" type="submit" id="commitBill" value="确认生成入库单">
      </label>
      （生成入库单，状态为未审核;如果实收差异不超过20%，采购单状态自动变为已入库，否则点此按钮后会弹出窗口询问入库与采购差异过大，是否认为该采购单已经执行，否的话采购单状态不变化）
    </p>
</form>
</body>
</html>
