...
<script type="text/javascript"
	src="<%=appRoot%>/jsp/restaurant/prototype/checkstorage/inputcheckitembill/commitCheckItemBill.js?Version=<%=currenttime %>"></script>
...
<input name="remarks" type="text" id="remarks" />
	...
	<div id="dataGrid"></div>
	<label>
	<input name="commitBill" type="submit" id="commitBill" value="餐厅盘点清单输入确认" />
	</label>
	（餐厅盘点清单输入确认，状态变为已输入）
	</form>
</body>
