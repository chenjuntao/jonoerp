...
<body bgcolor="white">
		...
		cellpadding="5" cellspacing="1" bordercolor="#BBEAC2">
          <tr  align="center" bgcolor="#006600">
            ...
            <th style="text-align:center;">根据入库单退货</th>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><a href='javascript: parent.addTab("采购退货单生成-入库单+编号", "<%=appRoot %>/jsp/restaurant/prototype/purchasereject/createpurchaserejectbill/createPurchaseReject.jsp");'
					>入库单退货</a></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            <th scope="row">2</th>
