...
<head>
	...
	<script type="text/javascript" src="<%=appRoot%>/jsp/restaurant/reportdamage/queryloss/listLossBill.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot%>/jsp/restaurant/reportdamage/queryloss/main.css">
</head>
...
<body class="claro" style="overflow:hidden">
	...
	<form id="listLossForm">
		<table class="hovertable" width="100%" border="1">
			<tr>
				<th colspan="6">
					<b>${brandWord}原料报损单列表</b>
				</th>
			</tr>
		
			<tr>
				<td style="width: 360px">报损日期：
				...
				<td style="width: 250px">
					门店：
					<s:select list="shopList" listKey="code" listValue="name" theme="simple" style="width: 180px;" id="branchId" name="branchId" onchange="refreshStorage()"></s:select>
