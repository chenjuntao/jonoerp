...
<head>
	<title>confirm before audit dish loss bill</title>
	<%@ include file="/jsp/common/jsp/path.jsp"%>

	<script type="text/javascript" src='<%=appRoot%>/jsp/common/lib/dojo/dojo.js'></script>
	<script type="text/javascript" src="<%=appRoot%>/jsp/common/js/dgrid-util.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot%>/jsp/restaurant/reportdamage/confirmdishloss/commitDishLossBill.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow: hidden;">
	...
	<table class="hovertable" id="commandTable">
		<tr>
			<th>
				<input id="doCommit" type="button" value="确认审核出品报损单" onclick="commitLoss()"/>
			</th>
		</tr>
	</table>
</body>
