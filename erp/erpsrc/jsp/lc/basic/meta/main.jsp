...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/basic/meta/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/basic/meta/main.css">
