...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/request/purchase/manual/selmaterial/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/request/purchase/manual/selmaterial/main.css">
