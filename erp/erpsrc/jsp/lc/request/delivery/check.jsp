...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/request/delivery/check.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<input type='hidden' name='shippingHeader.formType' value='OUTER' />
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td class="label_right" style="width: 120px;">出货单编号：</td>
				<td class="text_left" style="width: 180px;">
					<span>${formId }</span>
				</td>
				
				<td class="label_right" style="width: 60px;">出货部门：</td>
				<td class="text_left" style="width: 150px;">
					<span>${shippingHeader.provider }</span>
				</td>
				
				<td class="label_right" style="width: 60px;">出货日期：</td>
				<td class="text_left">
	...
	<table class="hovertable" id="commandTable" width="100%" border="1">
		<tr>
			<td style="text-align: center;">
			    <input type="button" id="btn_submit" value="确认生成出货单" style="padding-left: 8px;" />
			</td>
		</tr>
	</table>
</body>
