...
function CreateOneFormPage() {
	...
	LODOP.ADD_PRINT_TEXT(26, 274, 85, 20, "出货部门：");
	...
	LODOP.SET_PRINT_STYLEA(0, "ItemType", 1);
	LODOP.ADD_PRINT_TEXT(26, 16, 85, 20, "单据编号：");
	LODOP.SET_PRINT_STYLEA(0, "Alignment", 3);
	LODOP.SET_PRINT_STYLEA(0, "ItemType", 1);
	LODOP.ADD_PRINT_TEXT(26, 101, 170, 20, isEmpty(formId) ? "_" : formId);
	LODOP.SET_PRINT_STYLEA(0, "Bold", 1);
	...
	LODOP.ADD_PRINT_TEXT(0, 326, 112, 32, "出货单");
	LODOP.SET_PRINT_STYLEA(0, "FontName", "黑体");
	...
	// LODOP.SET_PRINT_STYLEA(0, "ItemType", 1);
	// LODOP.SET_PRINT_STYLEA(0, "Vorient", 1);
	LODOP.ADD_PRINT_TEXT(26, 551, 80, 20, "出货日期：");
	LODOP.SET_PRINT_STYLEA(0, "Alignment", 3);
	LODOP.SET_PRINT_STYLEA(0, "ItemType", 1);
	...
	var strBodyStyle = "<style> table {font-family: verdana,arial,"
			...
			+ ".print-itemSpecification {width: 90px;} .print-itemId {width:62px;} .print-packagingUnit ,.print-shippingCount{width:68px;text-align: right;} "
			+ ".print-itemName{text-align: left; width: 135px;}.print-requestCount,.print-receiveCount "
