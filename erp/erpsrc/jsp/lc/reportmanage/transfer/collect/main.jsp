...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/transfer/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/transfer/collect/print.css">
	...
	<form id="dataForm" method="post" >
	   ...
	   <tr>
				<td  style="width: 220px;">
					<label for="branchCondition">调入门店：</label>
					<input id="branchCondition" />
				</td>
				
				<td style="width: 280px;">
					 <label for="storageCondition">调入仓库：</label>
		...
		<tr>
				<td  style="width: 220px;">
					<label for="outBranchCondition">调出门店：</label>
					<input id="outBranchCondition" />
				</td>
				
				<td style="width: 280px;">
					 <label for="outStorageCondition">调出仓库：</label>
					<input id="outStorageCondition" />
				</td>
...
<!-- 		参数区域 -->
		...
		<input  name="collectFlag" type="hidden" value="head"/>
		
		<input id="append"  name="append" type="hidden" value=" AND b.BRANCH_TYPE = 'LOGISTICSCENTER' "/>
		<input id="branchType"   name="branchType" type="hidden" value="LOGISTICSCENTER"/>
		<input name="reportFlag" type="hidden" value="D_T1_TRANSFER_HEADER"/>
		</div>
	</form>
</body>
