...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/request/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/request/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/request/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/request/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/request/collect/print.css">
...
<!-- 		参数区域 -->
		...
		<input id="append"  name="append" type="hidden" value=" AND H.FORM_TYPE = 'request' "/>
