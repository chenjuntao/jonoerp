...
function getAppendValue() {
	...
	var appendValue = " AND b.BRANCH_TYPE = 'LOGISTICSCENTER' AND io.BRANCH_ID = '" + loginBranchId + "' ";
...
var typeArr = [ {
	id : 'YLBS',
	displayName : '物流中心原料报损'
}, {
	id : 'CGTH',
	displayName : '物流中心采购退货'
},
 {id:'DB',displayName:'调拨'},
{
	id : 'PSTH',
	displayName : '物流中心配送退货'
}, {
	id : 'PSFSH',
	displayName : '物流中心配送反审核'
}, {
	id : 'PSRK',
	displayName : '物流中心半成品入库'
}, {
	id : 'CGRK',
	displayName : '物流中心采购入库'
}, {
	id : 'PSCK',
	displayName : '物流中心配送出库'
}, {
	id : 'YKCK',
	displayName : '物流中心越库出库'
}, {
	id : 'WBCH',
	displayName : '物流中心外部出货'
}, {
	id : 'JSRK',
	displayName : '物流中心拒收入库'
}, {
	id : 'PD',
	displayName : '物流中心盘点'
} ];
