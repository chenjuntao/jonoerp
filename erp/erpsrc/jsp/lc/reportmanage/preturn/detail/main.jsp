...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/preturn/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/preturn/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/preturn/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/preturn/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/preturn/detail/print.css">
...
<div id="customDialog"  data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出/打印"'>
	...
	<form id="dataForm" method="post" >
	   		<table class="hovertable" width="100%" border="1" style="height: 35px;">
	   			<td class="label_right" style="width: 110px;">退货审核日期：</td>
			...
			<input name="reportFlag" type="hidden" value="D_T1_RETURN_GOODS_DETAIL"/>
		</div>
	</form>
</body>
