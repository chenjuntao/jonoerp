...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/stock/packing/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	...
	<div id="billInfo">
		...
		<div id="dataGrid" style="top: 92px;bottom:25px"></div>
		
		<table id="commandTable" class="hovertable">
			<tr>
				<td class="text_left" colspan="4" style="text-align: center;">
				    <input type="button" value="生成装箱单" onclick="doPack();" />
				</td>
			</tr>
		</table>
