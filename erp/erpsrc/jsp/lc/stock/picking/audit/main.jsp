...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/stock/picking/audit/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	...
	<div id="billInfo" style="bottom: 0px">
		...
		<div id="dataGrid" style="top: 62px;bottom: 33px"></div>
