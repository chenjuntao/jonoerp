...
<script type="text/javascript"
	src="<%=appRoot%>/mobile/module/dantiaudit/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript">
	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-user"></i>餐厅配送反审核明细报表
				</h2>
			</div>
			<div class="box-content">
				<form id="queryForm">
					...
					<input type="hidden" id="branchType" name="branchType" value="${branchType}" />
						...
						<tr>
							<td class="label_right" style="width: 80px;">分审核日期：</td>
