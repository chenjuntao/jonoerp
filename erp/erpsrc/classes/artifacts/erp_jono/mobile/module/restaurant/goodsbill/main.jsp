...
<script type="text/javascript" src="<%=appRoot%>/mobile/module/restaurant/goodsbill/main.js?Version=<%=currenttime %>"></script>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-user"></i>要货单查询
				</h2>
			</div>
				...
				<form id="queryForm">
					<table class="hovertable" width="100%" align="center">
						<tr>
							...
							<td><input type="text" id="startDate" value=""
								style="width: 80px;" /> <span style="padding: 0 5px;">至</span>
