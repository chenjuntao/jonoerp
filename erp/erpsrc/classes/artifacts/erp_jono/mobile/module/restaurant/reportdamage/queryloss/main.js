...
function getQueryUrl() {
	...
	var _url = appRoot + "/m/restaurant/reportdamage/queryloss/doQuery.action?formType=request";
	return _url + params;
}
function initTable() {
...
function doAudit(_formId) {
	...
	var _url = appRoot + "/restaurant/reportdamage/confirmloss/auditById.action?formId=" + _formId;
	$.ajax({
		type : "POST",
		url : _url,
		error : function(e) {
...
function gotoURL(_formId) {
	var _url = appRoot + "/restaurant/reportdamage/queryloss/showView.action?formId=" + _formId;
	window.open(_url);
}