...
<div style="width:100%;height: 100%;overflow:auto;">
	<table id="shopTable" class="hovertable table-striped" width="1600" border="1" align="center"
		...
		<c:forEach var="shopBean" items="${shops}">
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';" align="center">
				...
				<td><a
					href='javascript: gotoURL("<%=appRoot %>/businessquery/tableListQuery/listTable.action?shopC=${shopBean.shopC}&startDate=${startDate}&endDate=${endDate}");'
					>${shopBean.shopC} </a>
				</td>
				<td >${shopBean.shopName}</td>
				<td><a
					href='javascript: gotoURL("<%=appRoot %>/businessquery/paymentquery/doShopPayQuery.action?shopC=${shopBean.shopC}&startDate=${startDate}&endDate=${endDate}");'
					>付款方式 </a>
				</td>
