	...
	<table id="payTable" class="hovertable table-striped" width="100%" border="1" align="center"
		...
		<c:forEach var="shopBean" items="${shops}">
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';" align="center">
				...
				<td><a
					href='javascript: gotoURL("<%=appRoot %>/jsp/businessquery/payShopBillList.action?shopC=${shopBean.shopC}&shopName=${shopBean.shopName}&startDate=${startDate}&endDate=${endDate}&type=${index_str}&currentPage=0");'
