...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/input/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/input/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/input/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/input/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/input/collect/print.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_INPUT_HEADER"/>
		</div>
	</form>
</body>
