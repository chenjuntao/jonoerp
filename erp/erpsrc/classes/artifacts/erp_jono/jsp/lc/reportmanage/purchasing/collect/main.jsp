...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/purchasing/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/purchasing/collect/print.css">
	...
	<form id="dataForm" method="post" >
	   <table class="hovertable" width="100%" border="1" style="height: 35px;">
		...
		<div id="grid_print" class="print-only"></div>
			...
			<input name="reportFlag" type="hidden" value="D_T1_PURCHASING_HEADER"/>
		</div>
	</form>
</body>
