...
function getAppendValue() {
	...
	var appendValue = " AND b.BRANCH_TYPE = 'LOGISTICSCENTER'  AND H.LOSS_BRANCH_ID = '" + loginBranchId
			+ "' AND h.LOSS_TYPE = 'DISHLOSS' AND  d.REASON = 'DISH2RAW'";
	if (!isEmpty(branchFlag)) {
		appendValue = " AND b.BRANCH_TYPE = 'LOGISTICSCENTER' AND h.LOSS_TYPE = 'DISHLOSS' AND  d.REASON = 'DISH2RAW'";
	}
