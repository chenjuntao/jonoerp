...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/loss/dish/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/loss/dish/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/loss/dish/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/loss/dish/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/loss/dish/detail/print.css">
	...
	<form id="dataForm" method="post" >
	   <table class="hovertable" width="100%" border="1" style="height: 35px;">
				...
				<td  style="width: 220px;">
					<label for="branchCondition">报损门店：</label>
					<input id="branchCondition" />
				</td>
				
				<td style="width: 230px;">
					 <label for="storageCondition">报损仓库：</label>
