...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/purchasing/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/purchasing/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/purchasing/detail/print.css">
	...
	<form id="dataForm" method="post" >
	   <table class="hovertable" width="100%" border="1" style="height: 35px;">
				...
				<td  style="width: 220px;">
					<label for="branchCondition">订货部门：</label>
					<input id="branchCondition" />
				</td>
				
				<td style="width: 220px;">
					 <label for="supplierCondition">供应商：</label>
					<input id="supplierCondition" />
				</td>
				<td>
...
<!-- 		参数区域 -->
		...
		<input id="branchType"   name="branchType" type="hidden" value="ALL"/>
		<input name="reportFlag" type="hidden" value="D_T1_PURCHASING_DETAIL"/>
		<input name="branchFlag" type="hidden" value="ALL" id="branchFlag"/>
		</div>
	</form>
</body>
