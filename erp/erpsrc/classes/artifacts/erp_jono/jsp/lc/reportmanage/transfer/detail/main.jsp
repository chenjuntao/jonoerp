...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/transfer/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/transfer/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/transfer/detail/print.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_TRANSFER_DETAIL"/>
		</div>
	</form>
</body>
