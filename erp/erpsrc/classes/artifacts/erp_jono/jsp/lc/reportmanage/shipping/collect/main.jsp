...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/shipping/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/shipping/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/reportmanage/shipping/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/shipping/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/lc/reportmanage/shipping/collect/print.css">
	...
	<form id="dataForm" method="post" >
	   ...
	   <tr>
				<td  style="width: 250px;" >
					<label for="branchCondition">配送门店：</label>
					<input id="branchCondition" />
				</td>
				
				<td style="width: 280px;">
					 <label for="storageCondition">出货仓库：</label>
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_SHIPPING_HEADER"/>
		</div>
	</form>
</body>
