...
<head>
	<title>logistics center create input bill</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/stock/in/create/main.js?Version=<%=currenttime %>"></script>
    <style type="text/css">
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	...
	<tr>
		...
		<div id="billInfo">
			...
			<div id="dataGrid" class="commonGrid" style="top: 156px;bottom:33px"></div>
