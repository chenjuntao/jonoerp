...
<head>
	<title>cross distribution audit</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/request/distribution/audit/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/putinstorage/distribution/main.css">
