...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/request/purchase/create.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >	
		<input type='hidden' name='collectHeader.formId' value='${collectHeader.formId }' />
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" style="width: 150px;">
					<span>${collectHeader.formMaker }</span>
				</td>
			...
			<tr>
				...
				<td class="text_left" colspan="3">
					<span style="display: inline-block;width: 300px;">${collectHeader.formNote }</span>
