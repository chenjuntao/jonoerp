...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/request/purchase/audit/audit.js?Version=<%=currenttime %>"></script>
    <style type="text/css">
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="5">
	  				...
	  				<input type='hidden' id="maxPayItem" name='purchasingHeader.maxPayItem' value='${purchasingHeader.maxPayItem}' />
			    	<input type="button" onclick="doAudit();" id="auditBtn" value="确认审核" style="margin-left: 58px;" />
				</td>
			</tr>
		</table>
