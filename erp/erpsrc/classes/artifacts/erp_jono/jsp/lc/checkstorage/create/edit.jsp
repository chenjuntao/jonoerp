...
<head>
	...
	<script type="text/javascript">
		var batchId = '${checkHeader.checkBatchId }';
	</script>
</head>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="3">
			    	...
			    	<input type="button" onclick="doSave();" value="确认生成盘点单" style="margin-left: 58px;" />
				</td>
			</tr>
		</table>
		...
		<div id="dataGrid" class="commonGrid" style="top: 65px;"></div>
	</form>
</body>
