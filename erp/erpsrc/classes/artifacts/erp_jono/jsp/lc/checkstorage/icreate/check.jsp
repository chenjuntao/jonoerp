...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/checkstorage/icreate/check.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post">
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="3">
				    ...
				    <input type="button" id="btn_submit" value="确认生成盘点清单" style="margin-left: 58px;" />
		...
		<div id="dataGrid" class="checkGrid"></div>
	</form>	
</body>
