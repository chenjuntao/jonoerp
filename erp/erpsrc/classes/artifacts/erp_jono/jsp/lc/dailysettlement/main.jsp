...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/checkstorage/lock/price.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/checkstorage/lock/picking.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/lc/dailysettlement/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	...
	<input type="hidden" id="endDate" name="endDate" value="${businessDate}" />
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					<div style="padding-left: 8px;"><strong>未审核捡货单列表</strong></div>
				</td>
			</tr>
  		</table>
  		
  		<div id="pickingGrid" class="dataGrid"></div>
			<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					<div style="padding-left: 8px;"><strong>总部未审核调价单列表</strong></div>
				</td>
			</tr>
  		</table>
  		
  		<div id="priceGrid" class="dataGrid"></div>
