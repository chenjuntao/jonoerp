...
var grid = null;
function initGrid() {
	var _url = appRoot + "/hq/priceadjust/doQuery.action?adjustType=" + g_adjustType+"&queryType=unaudit";
	
	require([ "dgrid/Grid", "custom/store/Server", "dojo/store/Observable", "dojo/store/Cache", "dojo/store/Memory",
			"dojo/_base/declare", "dgrid/extensions/Pagination","dgrid/extensions/ColumnResizer", "dojo/domReady!" ], function(Grid, Server, Observable,
			Cache, Memory, declare, Pagination,ColumnResizer) {
