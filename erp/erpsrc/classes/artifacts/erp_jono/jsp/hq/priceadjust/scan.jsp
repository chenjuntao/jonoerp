...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/priceadjust/scan.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/priceadjust/export.js?Version=<%=currenttime %>"></script>
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 200px;" colspan="3">
