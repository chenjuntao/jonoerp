...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/orderscan/order.js"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/orderscan/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/orderscan/main.css">
...
<form id="dataForm" method="post" >
	<table class="hovertable" width="100%" border="1">
		<tr>
			...
			<td class="label_right" style="width: 70px;">单据状态：</td>
			<td class="text_left" >
<%-- 			<select id="status"> --%>
