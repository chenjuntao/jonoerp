...
require([ "dojo", "dojo/_base/lang", "dgrid/OnDemandGrid", "dgrid/selector", "dgrid/Selection", "dojo/store/JsonRest",
		...
		"dojo/_base/array", "dgrid/extensions/ColumnResizer","dojo/ready" ], function(dojo, lang, OnDemandGrid, selector, Selection, JsonRest, Cache,
		Memory, declare, query, Keyboard, array,ColumnResizer, ready) {
	ready(function() {
		// 获取父窗口的数据
		loadData();
		initGrid();
	...
	function initGrid() {
		var _url = appRoot + "/restaurant/reportdamage/selproduct/queryProduct.action";
 ...
 */
function doSelect() {
	parent.afterSelProduct(selectedRows);
}
