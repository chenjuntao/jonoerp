...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/fpgroup/brand/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/fpgroup/brand/dlg.js?Version=<%=currenttime %>"></script>
