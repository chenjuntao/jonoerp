...
function initCateTree() {
	var _url = appRoot + "/restaurant/shopSourceQuery/loadTree.action?itemType=RAW";
...
function queryItem() {
	var _url = appRoot + "/hq/period/supplier/doQuery.action?itemType=RAW&branchId=" + g_branchId;
