...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/item/product/seltherapyitem/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/config/item/product/seltherapyitem/main.css"/>
