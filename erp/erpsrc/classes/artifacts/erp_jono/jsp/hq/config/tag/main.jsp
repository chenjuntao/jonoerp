...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/config/tag/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/config/tag/main.css"/>
