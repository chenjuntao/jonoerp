...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/hq/accountscan/operate.js?Version=<%=currenttime %>"></script>
    ...
    <!-- 引用新增要货单页面create的样式 -->
	<link rel="stylesheet" href="<%=appRoot %>/jsp/hq/accountscan/operate.css">
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td  style="width: 200px;" >
					<input type="button" id="operateButton" onclick="doOperate();" value=""/>
				</td>
