...
<HTML>
	...
	<frameset rows="76,*"  id="frmstTop" frameborder="no" BORDER="0" framespacing="0" border="0">  
	   	<frame src="jsp/top.html" name="topFrame"  scrolling="no"  marginheight="0" marginwidth="1" >
		           <!--24% ,76%-->
		<frameset rows="*" cols="216,*" id="frmstOuter" frameborder="1" framespacing="1" bordercolor="#003300">
			<frame src="jsp/businessquery/navigation.jsp" name="navigation" title="menu"  frameborder="0" marginheight="0" marginwidth="1" >
<!-- 			<frame src="jsp/tab.html" name="tab" frameborder="0" scrolling="auto" marginheight="0" marginwidth="1"> -->
			<frame src="jsp/welcome.jsp" name="tab" frameborder="0" scrolling="auto" marginheight="0" marginwidth="1">
		</frameset>
	</frameset>
