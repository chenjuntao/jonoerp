...
if (hostname.indexOf("tanry") > -1) {// considering of welcome-file-list
	String _loginUrl = request.getContextPath() + "/jsp/login/product.jsp";
	response.sendRedirect(_loginUrl);
}
%>
