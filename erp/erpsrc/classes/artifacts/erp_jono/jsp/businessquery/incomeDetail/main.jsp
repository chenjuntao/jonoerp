...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/incomeDetail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/incomeDetail/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/businessquery/incomeDetail/main.css"/>
