...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/billreason/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/billreason/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/businessquery/billreason/main.css"/>
