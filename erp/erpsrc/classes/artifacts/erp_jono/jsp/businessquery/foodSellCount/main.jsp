...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/foodSellCount/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/businessquery/foodSellCount/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/businessquery/foodSellCount/main.css"/>
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr valign="middle">
				...
				<td class="text_left" ><select name="type" id = "type">
						<option value="dl">大类</option>
						<option value="xl">小类</option>
				</select></td>
				<td >
					<span> 
