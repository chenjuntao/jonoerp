...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/returnscan/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/supplier/returnscan/order.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/supplier/returnscan/main.css">
	...
	<table class="hovertable" width="100%" border="1">
		<tr>
			...
			<tr>
				...
				<input type="hidden" name="initStatus" value="供应商已确认,已审核"></input>
				<td class="label_right" style="width: 60px;">确认状态</td>
				<td class="text_left"  >
					<input type="radio" name="status" value="供应商已确认">已确认</input>
					<input type="radio" name="status" value="已审核">未确认</input>
