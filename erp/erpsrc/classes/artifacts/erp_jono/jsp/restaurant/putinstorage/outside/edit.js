...
function doSave() {
	...
	var _url = appRoot + "/restaurant/putinstorage/outside/doSave.action";
	_url = getUrl(_url);
...
function initGrid() {
	require([ "dgrid/OnDemandGrid", "dgrid/editor", "dijit/form/NumberTextBox", "dojo/_base/declare", "dgrid/Keyboard",
			"dojo/on", "dojo/keys", "dgrid/extensions/ColumnResizer", "dojo/query", "dojo/domReady!" ], function(
			OnDemandGrid, editor, NumberTextBox, declare, Keyboard, on, keys, ColumnResizer, query) {
...
function doDelete() {
	...
	var _url = appRoot + "/restaurant/putinstorage/outside/doDelete.action";
	_url = getUrl(_url);
