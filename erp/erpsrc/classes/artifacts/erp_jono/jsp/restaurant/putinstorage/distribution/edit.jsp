...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/putinstorage/distribution/edit.js?Version=<%=currenttime %>"></script>
	...
	<table id="commandTable" class="hovertable">
		<tr>
			<td class="text_left" colspan="4" style="text-align: center;">
			    <input type="button" value="确认填充配送单" onclick="doCheck();" />
			</td>
		</tr>
	</table>
</body>
