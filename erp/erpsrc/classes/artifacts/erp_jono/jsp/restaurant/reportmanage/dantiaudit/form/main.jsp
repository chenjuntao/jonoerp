...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/form/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/form/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/form/main.css">
   ...
   <table class="hovertable" width="100%" border="1" style="height: 35px;">
	   <tr>
		...
		<div id="gridContainer"  >
			...
			<input id="withOutSum"  name="withOutSum" type="hidden" value="withOutSum"/>
			<input name="reportFlag" type="hidden" value="D_T1_SHIPPING_ANTIAUDIT_FORM"/>
