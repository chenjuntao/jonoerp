...
function prn1_preview(object) {
	sizePx = dijit.byId('size').get('value');
...
function createPrintTable(id) {
	...
	require([ "dojo/request/xhr"],function(xhr){
		xhr.post(appRoot + "/reportmanage/common/print/print.action", {
			...
			LODOP.ADD_PRINT_TEXT(20,300,134,20,"餐厅要货明细报表");
			LODOP.ADD_PRINT_TEXT(20,545,134,20,"总页号：第#页/共&页");
			LODOP.SET_PRINT_STYLEA(0,"ItemType",2);
			
			var strBodyStyle="<style> table {font-family: verdana,arial,sans-serif;font-size:"+ sizePx +"px;" +
					"color:#333333;border-width: 1px;border-color: #666666;border-collapse: collapse;} td {border-width: 1px;	padding: 8px; 	border-style: solid; 	border-color: #666666;	background-color: #ffffff;} th {border-width: 1px;	padding: 8px;	border-style: solid;	border-color: #666666;}   </style>";
