...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/shipping/detail/print.css">
	...
	<form id="dataForm" method="post" >
	   ...
	   <tr>
			<td  style="width: 211px;">
				<label for="requestCondition">订货门店：</label>
				<input id="requestCondition" />
			</td>
				<td class="text_right" style="width: 36px;"><label
		...
		<input id="append"  name="append" type="hidden" value=" AND h.FORM_TYPE in ('INNER_UNIFIED','INNER_CROSS') "/>
		<input id="branchType"   name="branchType" type="hidden" value="LOGISTICSCENTER"/>
		<input name="reportFlag" type="hidden" value="D_T1_SHIPPING_DETAIL"/>
