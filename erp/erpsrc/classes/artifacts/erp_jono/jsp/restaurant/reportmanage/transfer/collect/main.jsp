...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/transfer/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/transfer/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/transfer/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/transfer/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/transfer/collect/print.css">
...
<!-- 查询条件区域 -->
	<form id="dataForm" method="post" >
	   ...
	   <tr>
		...
		<input id="append"  name="append" type="hidden" value=" AND b.BRANCH_TYPE = 'RESTAURANT' "/>
