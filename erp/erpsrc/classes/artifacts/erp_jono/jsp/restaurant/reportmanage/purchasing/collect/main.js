...
function init() {
	require([ "dojo/dom", "dojo/request/xhr", "dojo/_base/array", "dojo/dom-form", "dojo/parser", "dijit/form/Select",
			"dojo/data/ObjectStore", "dojo/store/Memory", "dijit/form/FilteringSelect", "dojo/_base/array",
			"dijit/form/Button", "dijit/Dialog", "dojo/domReady!" ], function(dom, xhr, array, domForm, parser, Select,
			ObjectStore, Memory, FilteringSelect, arrayUtil) {
		parser.parse();
		...
		xhr.post(appRoot + "/common/listBs.action", {
			handleAs : "json",
			data : {
				branchType1 : dojo.byId("branchType").value
			}
		}).then(function(data) {
