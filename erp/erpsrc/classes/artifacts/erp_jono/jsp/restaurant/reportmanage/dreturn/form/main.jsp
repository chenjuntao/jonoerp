...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/form/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/form/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/dreturn/form/main.css">
...
<!-- 查询条件区域 -->
	   ...
	   <tr>
		...
		<div id="gridContainer"  >
			...
			<input name="reportFlag" type="hidden" value="D_T1_RETURN_GOODS_DELIVERY_FORM"/>
