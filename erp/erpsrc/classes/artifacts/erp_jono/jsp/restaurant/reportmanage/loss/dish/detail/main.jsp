...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/loss/dish/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/loss/dish/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/loss/dish/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/loss/dish/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/loss/dish/detail/print.css">
...
<div id="customDialog"  data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出/打印"'>
	...
	<form id="dataForm" method="post" >
	   <table class="hovertable" width="100%" border="1" style="height: 35px;">
		...
		<input name="reportFlag" type="hidden" value="D_T1_LOSS_DETAILS"/>
