...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/collect/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/collect/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/collect/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/collect/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/reportmanage/dantiaudit/collect/print.css">
...
<form id="dataForm" method="post" >
   <table class="hovertable" width="100%" border="1" style="height: 35px;">
	   <tr>
	   			<td class="label_right" style="width: 80px;">订货门店：</td>
	  			<td  style="width: 300px;">
					<input id="branchCondition2" />
				</td>
				
				<td class="label_right" style="width: 80px;">入库仓库：</td>
				<td>
					<input id="storageCondition2" />
				</td>
		</tr>
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_SHIPPING_ANTIAUDIT_HEADER"/>
