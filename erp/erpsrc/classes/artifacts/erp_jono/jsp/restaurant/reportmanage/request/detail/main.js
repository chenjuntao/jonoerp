...
function init() {
	require([ "dojo/dom", "dojo/request/xhr", "dojo/_base/array", "dojo/dom-form", "dojo/parser", "dijit/form/Select",
			"dojo/data/ObjectStore", "dojo/store/Memory", "dijit/form/FilteringSelect", "dijit/form/NumberSpinner",
			"dijit/InlineEditBox", "dijit/form/Button", "dijit/Dialog", "dojo/domReady!" ], function(dom, xhr, array,
