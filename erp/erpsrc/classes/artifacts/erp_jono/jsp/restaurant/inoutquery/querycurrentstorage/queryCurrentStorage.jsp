...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/querycurrentstorage/export.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" border="1" bordercolor="#FEB5AE" bgcolor="#E9EFF5" width="100%">
			<tr>
				...
				<td class="text_left">
					...
					style="width: 100px;" id="shopC" name="shopC" onchange="branchChange(shopC,storageId)"></s:select>
				</td>
				
				<td class="label_right">仓库：</td>
				<td>
					<s:select list="storageList" listKey="storageId" listValue="storageName" theme="simple"
					style="width: 100px;" id="storageId" name="storageId" ></s:select>
				</td>
