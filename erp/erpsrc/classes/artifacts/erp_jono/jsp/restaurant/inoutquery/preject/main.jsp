...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/preject/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/inoutquery/preject/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/inoutquery/preject/main.css">
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 260px;">
					...
					<input type="text" class="Wdate" id="startDate" name="startDate" value="${startDate}" style="width: 110px;"
				...
				<td>
					<s:select list="storageList" listKey="storageId" listValue="storageName" theme="simple" headerKey="" headerValue="--请选择--"
					style="width: 180px;" id="storageId" ></s:select>
