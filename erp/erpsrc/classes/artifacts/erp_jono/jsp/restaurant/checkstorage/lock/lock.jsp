...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/checkstorage/lock/lock.js?Version=<%=currenttime %>"></script>
		...
		<table style="width: 100%;">
			<tr>
				<td class="text_left" colspan="4" style="text-align: center;">
				    <input type="button" value="生成批次号" onclick="doSubmit();" />
				</td>
			</tr>
		</table>
	</form>
