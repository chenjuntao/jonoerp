...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/checkstorage/create/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<div id="dataGrid" class="commonGrid" style="top:95px;bottom:35px"></div>
	</form>
	...
	<table id="commandTable" class="hovertable" width="100%" border="1">
		<tr>
			<td class="text_left" colspan="4" style="text-align: center;">
			    <input type="button" onclick="doSubmit();" value="餐厅盘点单生成" style="margin-left: 8px;" />
			</td>
		</tr>
	</table>
</body>
