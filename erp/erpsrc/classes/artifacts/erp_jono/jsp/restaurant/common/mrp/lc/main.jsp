...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/common/mrp/lc/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/common/mrp/lc/export.js?Version=<%=currenttime %>"></script>
...
<div id="customDialog"  data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出"'>
	...
	<div id="selectItemDiv">
		<table class="hovertable" width="100%">
			<tr>
				...
				<td class="text_left">
		 			<input type="text" id="itemName" style="width: 120px;" />
		 		</td>
			</tr>
		</table>
	...
	<div id="queryStorageGrid">
		<table class="hovertable" width="100%">
			<tr>
				...
				<td class="text_left" style="width: 120px;">
					<s:select list="shopLst" listKey="code" listValue="name" theme="simple"	 id="branchId" name="branchId" onchange= "changeStorage()"></s:select>
				</td>
		...
		<div id="storageGrid" class="commonGrid" style="top:33px"></div>
	</div>
</body>
