...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/common/selsupplier/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro">
	<table class="hovertable" width="100%" border="1">
		<tr>
			<td class="label_right" style="width: 120px;">供应商名称或编码：</td>
			<td>
