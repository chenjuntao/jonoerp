...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/common/stock/category/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/common/stock/category/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/common/stock/category/main.css">
</head>
...
<div id="customDialog"  data-dojo-type="dijit/Dialog" data-dojo-props='title:"导出"'>
	...
	<div id="queryStorageGrid">
		<table class="hovertable" width="100%">
			<tr>
				<td class="label_right" style="width: 40px;">部门：</td>
				...
				<td class="label_right" style="width: 40px;">库存：</td>
				<td class="text_left" style="width: 60px;">
					<s:select list="numLst" listKey="types" listValue="name" theme="simple"
 						 id="types"></s:select>
				</td>
				
				<td class="label_right" style="width: 40px;">仓库：</td>
				<td class="text_left">
					<s:select list="storeLst" listKey="storageId" listValue="storageName" theme="simple" style="width: 160px;" id="storageId"></s:select>
					
					<span style="display: inline-block;width: 20px;"></span>
					<input id="queryBtn" type="button" value="查询库存" />
