...
<table class="hovertable" width="100%" border="1" cellpadding="6" cellspacing="2"
    ...
    <p>
      <label>
      <input name="beginAntiAudit" type="submit" id="beginAntiAudit" value="确定生成配送反审核单">
      </label>
      （生成配送反审核单，状态是未处理）
    </p>
</body>
