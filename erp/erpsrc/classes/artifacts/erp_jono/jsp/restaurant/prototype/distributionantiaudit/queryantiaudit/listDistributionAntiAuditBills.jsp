...
<body bgcolor="white">
		...
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>注：查询并显示该门店（配送反审核单中订货部门是该餐厅）所有符合时间区间的配送反审核单<label for="textfield"></label>
</p>
		<table class="hovertable" width="100%" border="1" cellpadding="6" cellspacing="2"
			bordercolor="#FEB5AE" bgcolor="#E9EFF5" align="center">
          <tr valign="middle">
            <td width="800"><div align="Left"><b>配送反审核单列表</b></div></td>
          </tr>
        </table>
		...
		cellpadding="5" cellspacing="1" bordercolor="#BBEAC2">
          <tr  align="center" bgcolor="#006600">
            ...
            <th style="text-align:center;">配送反审核单号</th>
            <th bgcolor="#666666" style="text-align:center;">配送反审核部门</th>
            <th bgcolor="#666666" style="text-align:center;">配送反审核人员</th>
            <th bgcolor="#666666" style="text-align:center;">配送反审核日期</th>
            <th style="text-align:center;">配送反审核备注</th>
            ...
            <th style="text-align:center;">配送单备注</th>
            <th bgcolor="#666666" style="text-align:center;">主要配送品</th>
            <th style="text-align:center;">单据状态</th>
            <th style="text-align:center;">单据查看</th>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><a	href='javascript: parent.addTab("配送反审核单据查看-配送反审核单+编号", "<%=appRoot %>/jsp/restaurant/prototype/distributionantiaudit/queryantiaudit/queryDistributionAntiAuditBills.jsp");'
					>查看</a></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            <th scope="row">2</th>
