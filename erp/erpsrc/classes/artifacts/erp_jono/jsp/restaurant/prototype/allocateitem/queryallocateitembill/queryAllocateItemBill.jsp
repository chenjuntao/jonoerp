...
<script type="text/javascript"
	src="<%=appRoot%>/jsp/restaurant/prototype/allocateitem/queryallocateitembill/queryAllocateItemBill.js?Version=<%=currenttime %>"></script>
...
<input name="agreeDate" type="text" id="agreeDate" />
	...
	<p class="area_blank">调出人员
      <label>
      <input name="allocatePeople" type="text" id="allocatePeople" />
      </label>
调出日期
<label>
<input name="allocateDate" type="text" id="allocateDate" />
</label>
</p>
