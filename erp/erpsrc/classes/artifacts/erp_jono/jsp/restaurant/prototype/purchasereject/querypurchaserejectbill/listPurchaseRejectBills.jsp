...
<p>&nbsp;</p>
		...
		cellpadding="5" cellspacing="1" bordercolor="#BBEAC2">
          <tr  align="center" bgcolor="#006600">
            ...
            <th style="text-align:center;">查看采购退货单</th>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><a href='javascript: parent.addTab("采购退货单查看-采购退货单+编号", "<%=appRoot %>/jsp/restaurant/prototype/purchasereject/querypurchaserejectbill/queryPurchaseRejectBill.jsp");'
					>查看</a></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            <th scope="row">2</th>
