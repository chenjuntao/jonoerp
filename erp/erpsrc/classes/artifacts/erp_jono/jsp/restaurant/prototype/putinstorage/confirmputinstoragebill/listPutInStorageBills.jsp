...
<body bgcolor="white">
	...
	<table class="hovertable" width="100%" border="1" align="center"
      ...
      <td>未审核</td>
      <td><a
					href='javascript: parent.addTab("入库单审核-入库单+编号", "<%=appRoot %>/jsp/restaurant/prototype/putinstorage/confirmputinstoragebill/confirmPutInStorageBill.jsp");'
					>审核入库单</a></td>
      </tr>
			<tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
      <th scope="row">2</th>
