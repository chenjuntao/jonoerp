...
<script type="text/javascript"
	src="<%=appRoot%>/jsp/restaurant/prototype/allocateitem/confirmallocateitembill/confirmAllocateItemBill.js?Version=<%=currenttime %>"></script>
...
<input name="allocateFromDepartment" type="text" id="allocateFromDepartment" />
  ...
  <input name="createBillDate" type="text" id="createBillDate" />
	...
	<div id="dataGrid">输入对申请调拨数量的修改</div>
	
	<label>
	<input name="confirmAllocateItemBill" type="submit" id="confirmAllocateItemBill" value="餐厅调拨单审核通过" />
	</label>
	（注：餐厅调拨单状态从未审核变为未确认）
	</form>
</body>
