...
<p>
  <label>
  <input name="deleteBill" type="submit" id="deleteBill" value="删除单据" />
  <input name="disableBill" type="submit" id="disableBill" value="作废单据" />
  <input name="confirmModify" type="submit" id="confirmModify" value="确认修改" />
  </label>
  <label>
