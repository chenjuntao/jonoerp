...
<body bgcolor="white">
		...
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>注：查询并显示该门店所有未审核的配送退货单<label for="textfield"></label>
  </p>
		...
		cellpadding="5" cellspacing="1" bordercolor="#BBEAC2">
          <tr  align="center" bgcolor="#006600">
            ...
            <th style="text-align:center;">审核配送退货单</th>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            ...
            <td>&nbsp;</td>
            <td>未审核</td>
            <td><a href='javascript: parent.addTab("配送退货单审核-配送退货单+编号", "<%=appRoot %>/jsp/restaurant/prototype/distributionreject/confirmdistributionrejectbill/confirmDistributionRejectBill.jsp");'
					>审核</a></td>
          </tr>
          <tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
            <th scope="row">2</th>
