...
配送单据编号</label>
          <input name="distributionBillNumber" type="text" id="distributionBillNumber" value="PS031304210319" size="18" />单据状态
          <label>
          <input name="billState" type="text" id="billState" value="未审核">
          </label>
<p align="left">配送部门
          <label>
