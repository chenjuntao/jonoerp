...
配送单入库日期
    <input name="putInStorageDate" type="text" id="label2" value="2012-04-21" size="15" /><label for="label3"></label>
  配送单备注
  <input name="distributionRemarks" type="text" id="distributionRemarks" />
</p>
<p align="left">配送反审核人员
...
<table class="hovertable" width="100%" border="1" cellpadding="6" cellspacing="2"
	...
	<table class="hovertable" width="100%" border="1" align="center"
		...
		<tr  align="center" bgcolor="#006600">
    		...
    		<th style="text-align:center;">原实收数</th>
    		<th style="text-align:center;">反审核实收数</th>
    		<th style="text-align:center;">单价</th>
			<th style="text-align:center;">原金额</th>
			<th style="text-align:center;">反审核金额</th>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><span class="STYLE1">重新输入</span></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><p class="STYLE1">反审核实收数</p>
        <p class="STYLE1">*单价</p>        </td>
      <td>&nbsp;</td>
    </tr>
			<tr onMouseOver="this.style.backgroundColor='#ffff66';" onMouseOut="this.style.backgroundColor='#d4e3e5';"  align="center">
      <th scope="row">2</th>
    ...
    <p>
      <label><a
					href='javascript: parent.addTab("配送反审核生成", "<%=appRoot %>/jsp/restaurant/prototype/distributionantiaudit/createantiaudit/commitantiaudit.jsp");'
					>确定生成配送反审核单</a> </label>
</p>
</body>
</html>
