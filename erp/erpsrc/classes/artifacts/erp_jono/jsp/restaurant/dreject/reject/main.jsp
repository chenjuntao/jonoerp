...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/dreject/reject/main.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/restaurant/dreject/reject/main.css">
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left">
					<s:select list="shopLst" listKey="code" listValue="name" theme="simple"	headerKey="" headerValue="--请选择--"  style="width: 150px;" id="branchId"></s:select>
