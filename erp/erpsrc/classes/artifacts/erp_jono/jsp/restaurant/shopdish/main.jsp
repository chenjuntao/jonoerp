...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/shopdish/main.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					...
					<input type="text" id="condition" name="condition" onkeydown="if(event.keyCode==13){doQuery();return false;}" style="margin-left: 8px;" />
