...
<head>
	...
	<script type="text/javascript" src="<%=appRoot%>/jsp/restaurant/reportdamage/confirmdishloss/listDishLossBill.js?Version=<%=currenttime %>"></script>
