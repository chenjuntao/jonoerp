...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/preject/manage/mainOut.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td class="label_right" style="width: 30px;">退货日期：</td>
