...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/preject/confirm/confirm.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left">
					...
					<input type='hidden' name="branchId" value='${inputHeader.inputDepartmentId }' />
				</td>
	...
	<table class="hovertable" width="100%" border="1">
		<tr>
			<td style="text-align: center;">
			    <input type="button" onclick="doConfirm();" id="btn_submit" value="确认采购退货单" style="margin-left: 8px;" />
			</td>
		</tr>
	</table>
