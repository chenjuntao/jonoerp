...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/restaurant/goodsbill/query/main.js?Version=<%=currenttime %>"></script>
	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="label_right" style="width: 80px;">要货部门：</td>
