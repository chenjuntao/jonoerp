...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/setting/role/add.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left" style="width: 120px;">
		 			<input type="text" id="roleId" name="role.roleId"
		 				 value="${role.roleId}" style="width: 80px;" />
				</td>
