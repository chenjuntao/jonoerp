...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/reportmanage/request/form/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/reportmanage/request/form/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/reportmanage/request/form/main.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_REQUEST_FORM"/>
		</div>
	</form>
</body>
