...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/template/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="queryForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td class="label_right" style="width: 100px;">到货周期：</td>
				<td class="text_left" style="width: 60px;">
					<s:select list="periodLst" listKey="key" listValue="value" theme="simple" 	id="arrivePeriod" headerKey="-1" headerValue="--请选择--" ></s:select>
				</td>
				
				<td class="label_right" style="width: 60px;">原料名称：</td>
				<td class="text_left" colspan="3">
		 			<input type="text" id="itemName" style="width: 150px;" />
				</td>
			</tr>
