...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/statement/manage/operate.js?Version=<%=currenttime %>"></script>
    ...
    <!-- 引用新增要货单页面create的样式 -->
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/statement/manage/scan.css">
