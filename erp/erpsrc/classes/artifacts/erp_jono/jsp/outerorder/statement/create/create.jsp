...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/statement/create/create.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/statement/create/create.css">
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td  style="width: 150px;" >
					<input type="text" id="formNote" name="statement.formNote"/>
				</td>
