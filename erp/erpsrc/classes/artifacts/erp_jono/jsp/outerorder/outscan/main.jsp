...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/outerorder/outscan/main.js?Version=<%=currenttime %>"></script>
		<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/outerorder/outscan/main.css">
...
<%-- 						 style="width: 180px;" id="branchId" headerKey="" headerValue="--请选择--" ></s:select> --%>
						 	<s:select list="shopLst" listKey="code" listValue="name" theme="simple"
						 style="width: 180px;" id="branchId" ></s:select>
				</td>
