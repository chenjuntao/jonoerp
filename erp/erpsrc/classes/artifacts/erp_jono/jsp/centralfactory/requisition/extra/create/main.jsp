...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/extra/create/main.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<table class="hovertable" width="100%" border="1">
		<tr>
			<td class="label_right" style="width: 100px;">工单制单日期：</td>
			<td class="text_left">
	...
	<input type="hidden" id="queryStr" value="  h.RECEIVED_STATUS in('receiving','received') and s.status = '已审核' "/>
