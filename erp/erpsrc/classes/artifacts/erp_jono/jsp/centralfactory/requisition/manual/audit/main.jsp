...
<head>
	<title>manual requisition confirm</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/manual/audit/main.js?Version=<%=currenttime %>"></script>
