...
<head>
	<title>return material manage</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/return/manage/main.js?Version=<%=currenttime %>"></script>
