...
<head>
	<title>manual requisition manage</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/manual/manage/main.js?Version=<%=currenttime %>"></script>
			...
			<tr>
				...
				<td class="text_left">
					...
					<span style="padding-left: 58px;">
						<input type="button" onclick="doQuery();" value="查    询">
					</span>
				</td>
			</tr>
		</table>
