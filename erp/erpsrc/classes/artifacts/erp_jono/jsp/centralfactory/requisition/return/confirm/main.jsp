...
<head>
	<title>requisition confirm</title>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/requisition/return/confirm/main.js?Version=<%=currenttime %>"></script>
