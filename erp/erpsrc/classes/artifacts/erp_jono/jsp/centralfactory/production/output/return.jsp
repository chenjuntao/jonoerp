...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/production/output/return.js?Version=<%=currenttime %>"></script>
...
<body class="claro" style="overflow-y: auto;overflow-x: hidden;">
	<form id="billForm" method="post" >
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				...
				<td class="text_left" colspan="5">
				    ...
				    <input type="button" onclick="doCommit();" value="退料单生成" style="margin-left: 58px;width: 80px;" />
			    	<input type="button" onclick="doClose();" value="取    消" style="margin-left: 28px;width: 60px;" />
				</td>
			</tr>
		</table>
		...
		<input type="hidden" name="queryStr" value=" s.status = '已审核' "/>
