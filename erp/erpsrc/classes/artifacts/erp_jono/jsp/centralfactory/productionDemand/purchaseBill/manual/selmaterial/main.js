...
require([ "dojo", "dojo/_base/lang", "dgrid/OnDemandGrid", "dgrid/selector", "dgrid/Selection", "dojo/store/JsonRest",
		...
		"dojo/_base/array", "dojo/ready", "dgrid/extensions/ColumnResizer" ], function(dojo, lang, OnDemandGrid,
		selector, Selection, JsonRest, Cache, Memory, declare, query, Keyboard, array, ready, ColumnResizer) {
	ready(function() {
		// 获取父窗口的数据
		loadData();
		initGrid();
	...
	function initGrid() {
		var _url = appRoot + "/centralfactory/productionDemand/purchaseBill/manual/selmaterial/doQuery.action";
		_url = getUrl(_url);
