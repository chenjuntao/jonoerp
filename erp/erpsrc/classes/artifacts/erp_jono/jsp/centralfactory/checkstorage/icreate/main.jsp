...
<head>
	<title>check list create</title>
	<%@ include file="/jsp/common/jsp/path.jsp"%>
	
	<script type="text/javascript" src='<%=dojoBase %>/dojo/dojo.js' data-dojo-config="async:1"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/dgrid-util.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/common/js/common.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/checkstorage/icreate/main.js?Version=<%=currenttime %>"></script>
		...
		<table class="hovertable" width="100%" border="1">
			...
			<tr>
				<td colspan="4">
			    	...
			    	<input type="button" id="saveModel" onclick="saveAsModel();" value="存为模板" style="margin-left: 8px;" />
			    	<input type="button" id="DIYwithnoModel" onclick="selMaterial();" value="自选原料" style="margin-left: 8px;" />
				</td>
			</tr>
		...
		<table class="hovertable"  id="commandTable" width="100%" border="1">
			<tr>
				<td class="text_left" colspan="4" style="text-align: center;">
				    <input type="button" id="btn_submit" value="生成盘点清单" style="margin-left: 8px;" />
				</td>
			</tr>
		</table>
	</form>
