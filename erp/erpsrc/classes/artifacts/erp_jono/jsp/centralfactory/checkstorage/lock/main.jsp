	...
	<form id="billForm" method="post" >
		<table class="hovertable" width="100%" border="1">
			<tr>
				...
				<td class="text_left">
					<input type='hidden' id='branchId' value='${cfCode }' />
...
<!-- 		<div id="antiauditGrid" class="dataGrid"></div> -->
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					<div style="padding-left: 8px;"><strong>未审核和未处理领料单列表</strong></div>
				</td>
			</tr>
  		</table>
		...
		<table class="hovertable" width="100%" border="1">
			<tr>
				<td colspan="4">
					<div style="padding-left: 8px;"><strong>未审核和未处理非工单领料单列表</strong></div>
				</td>
			</tr>
  		</table>
