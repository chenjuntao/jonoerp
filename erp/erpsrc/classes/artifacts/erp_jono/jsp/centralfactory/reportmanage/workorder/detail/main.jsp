...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/workorder/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/workorder/detail/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/reportmanage/workorder/detail/main.css">
...
<!-- 		参数区域 -->
		...
		<input name="reportFlag" type="hidden" value="D_T1_WORK_ORDER_DETAIL"/>
		</div>
	</form>
</body>
