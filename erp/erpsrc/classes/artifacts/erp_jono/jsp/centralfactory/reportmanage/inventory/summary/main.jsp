...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/inventory/summary/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/inventory/summary/export.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/reportmanage/inventory/summary/main.css">
