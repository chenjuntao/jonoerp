...
<head>
	...
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/transfer/detail/main.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/transfer/detail/export.js?Version=<%=currenttime %>"></script>
	<script type="text/javascript" src="<%=appRoot %>/jsp/centralfactory/reportmanage/transfer/detail/print.js?Version=<%=currenttime %>"></script>
	...
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/reportmanage/transfer/detail/main.css">
	<link rel="stylesheet" href="<%=appRoot %>/jsp/centralfactory/reportmanage/transfer/detail/print.css">
