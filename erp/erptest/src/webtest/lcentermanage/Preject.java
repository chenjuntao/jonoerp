...
public class Preject {
	...
	public void testTt() throws Exception {
		...
		// 生成采购单
		tester.clickLeftMenu("物流中心退货管理", "物流中心采购退货生成");
		tester.switchRightTab("物流中心采购退货生成");
		...
		// 采购退货审核
		tester.clickLeftMenu("物流中心退货管理", "物流中心采购退货审核");
		tester.switchRightTab("物流中心采购退货审核");
