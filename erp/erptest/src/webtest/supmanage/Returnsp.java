...
public class Returnsp {
	...
	public void testRequirement() throws Exception {
		...
		Thread.sleep(1000);
		tester.clickLeftMenu("供应商供应流程管理", "退货单查询");
		tester.switchRightTab("退货单查询");
		...
		tester.switchRightTabLike("对账确认-");
		driver.findElement(By.xpath("//input[@value='对账确认']")).click();
